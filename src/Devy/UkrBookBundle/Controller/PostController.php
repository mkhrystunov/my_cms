...
class PostController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('DevyUkrBookBundle:Post:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('DevyUkrBookBundle:Post:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        return $this->render('DevyUkrBookBundle:Post:show.html.twig', array(
            'entity'      => $entity,
